...
type IvkDecryptTRC20Parameters struct {
	...
	Ak                            []byte                 `protobuf:"bytes,5,opt,name=ak,proto3" json:"ak,omitempty"`
	Nk                            []byte                 `protobuf:"bytes,6,opt,name=nk,proto3" json:"nk,omitempty"`
	// Deprecated: Marked as deprecated in api/api.proto.
...
const file_api_api_proto_rawDesc = "" +
	"\n" +
	"\rapi/api.proto\x12\bprotocol\x1a\x0fcore/Tron.proto\x1a(core/contract/asset_issue_contract.proto\x1a$core/contract/account_contract.proto\x1a$core/contract/witness_contract.proto\x1a$core/contract/balance_contract.proto\x1a%core/contract/proposal_contract.proto\x1a$core/contract/storage_contract.proto\x1a%core/contract/exchange_contract.proto\x1a#core/contract/market_contract.proto\x1a\"core/contract/smart_contract.proto\x1a#core/contract/shield_contract.proto\"\xc3\x03\n" +
	"\x06Return\x12\x16\n" +
	...
	"\x0eparameter_type\x18\x06 \x01(\tR\rparameterType\"\x84\x02\n" +
	...
	"\x02ak\x18\x05 \x01(\fR\x02ak\x12\x0e\n" +
	"\x02nk\x18\x06 \x01(\fR\x02nk\x12\x1a\n" +
	"\x06events\x18\a \x03(\tB\x02\x18\x01R\x06events\"\xe4\x01\n" +
	"\x19OvkDecryptTRC20Parameters\x12*\n" +
	"\x11start_block_index\x18\x01 \x01(\x03R\x0fstartBlockIndex\x12&\n" +
	"\x0fend_block_index\x18\x02 \x01(\x03R\rendBlockIndex\x12\x10\n" +
	"\x03ovk\x18\x03 \x01(\fR\x03ovk\x12E\n" +
	"\x1fshielded_TRC20_contract_address\x18\x04 \x01(\fR\x1cshieldedTRC20ContractAddress\x12\x1a\n" +
	"\x06events\x18\x05 \x03(\tB\x02\x18\x01R\x06events\"\xb4\x02\n" +
	...
	"\x16transparent_to_address\x18\x04 \x01(\fR\x14transparentToAddress2\xf5^\n" +
	"\x06Wallet\x124\n" +
	"\n" +
	"GetAccount\x12\x11.protocol.Account\x1a\x11.protocol.Account\"\x00\x128\n" +
	"\x0eGetAccountById\x12\x11.protocol.Account\x1a\x11.protocol.Account\"\x00\x12X\n" +
	"\x11GetAccountBalance\x12\x1f.protocol.AccountBalanceRequest\x1a .protocol.AccountBalanceResponse\"\x00\x12b\n" +
	"\x14GetBlockBalanceTrace\x12+.protocol.BlockBalanceTrace.BlockIdentifier\x1a\x1b.protocol.BlockBalanceTrace\"\x00\x12H\n" +
	"\x11CreateTransaction\x12\x1a.protocol.TransferContract\x1a\x15.protocol.Transaction\"\x00\x12R\n" +
	"\x12CreateTransaction2\x12\x1a.protocol.TransferContract\x1a\x1e.protocol.TransactionExtention\"\x00\x12A\n" +
	"\x14BroadcastTransaction\x12\x15.protocol.Transaction\x1a\x10.protocol.Return\"\x00\x12I\n" +
	"\rUpdateAccount\x12\x1f.protocol.AccountUpdateContract\x1a\x15.protocol.Transaction\"\x00\x12G\n" +
	"\fSetAccountId\x12\x1e.protocol.SetAccountIdContract\x1a\x15.protocol.Transaction\"\x00\x12S\n" +
	"\x0eUpdateAccount2\x12\x1f.protocol.AccountUpdateContract\x1a\x1e.protocol.TransactionExtention\"\x00\x12L\n" +
	"\x12VoteWitnessAccount\x12\x1d.protocol.VoteWitnessContract\x1a\x15.protocol.Transaction\"\x00\x12R\n" +
	...
	"\x10CreateAssetIssue\x12\x1c.protocol.AssetIssueContract\x1a\x15.protocol.Transaction\"\x00\x12S\n" +
	"\x11CreateAssetIssue2\x12\x1c.protocol.AssetIssueContract\x1a\x1e.protocol.TransactionExtention\"\x00\x12I\n" +
	"\rUpdateWitness\x12\x1f.protocol.WitnessUpdateContract\x1a\x15.protocol.Transaction\"\x00\x12S\n" +
	"\x0eUpdateWitness2\x12\x1f.protocol.WitnessUpdateContract\x1a\x1e.protocol.TransactionExtention\"\x00\x12I\n" +
	"\rCreateAccount\x12\x1f.protocol.AccountCreateContract\x1a\x15.protocol.Transaction\"\x00\x12S\n" +
	"\x0eCreateAccount2\x12\x1f.protocol.AccountCreateContract\x1a\x1e.protocol.TransactionExtention\"\x00\x12I\n" +
	"\rCreateWitness\x12\x1f.protocol.WitnessCreateContract\x1a\x15.protocol.Transaction\"\x00\x12S\n" +
	"\x0eCreateWitness2\x12\x1f.protocol.WitnessCreateContract\x1a\x1e.protocol.TransactionExtention\"\x00\x12I\n" +
	...
	"\x15ParticipateAssetIssue\x12'.protocol.ParticipateAssetIssueContract\x1a\x15.protocol.Transaction\"\x00\x12c\n" +
	...
	"\x0fFreezeBalanceV2\x12!.protocol.FreezeBalanceV2Contract\x1a\x1e.protocol.TransactionExtention\"\x00\x12M\n" +
	...
	"\x11UnfreezeBalanceV2\x12#.protocol.UnfreezeBalanceV2Contract\x1a\x1e.protocol.TransactionExtention\"\x00\x12I\n" +
	"\rUnfreezeAsset\x12\x1f.protocol.UnfreezeAssetContract\x1a\x15.protocol.Transaction\"\x00\x12S\n" +
	"\x0eUnfreezeAsset2\x12\x1f.protocol.UnfreezeAssetContract\x1a\x1e.protocol.TransactionExtention\"\x00\x12M\n" +
	...
	"\x13CancelAllUnfreezeV2\x12%.protocol.CancelAllUnfreezeV2Contract\x1a\x1e.protocol.TransactionExtention\"\x00\x12E\n" +
	"\vUpdateAsset\x12\x1d.protocol.UpdateAssetContract\x1a\x15.protocol.Transaction\"\x00\x12O\n" +
	...
	"\x11GetMarketPairList\x12\x16.protocol.EmptyMessage\x1a\x1d.protocol.MarketOrderPairList\"\x00\x129\n" +
	"\tListNodes\x12\x16.protocol.EmptyMessage\x1a\x12.protocol.NodeList\"\x00\x12G\n" +
	"\x16GetAssetIssueByAccount\x12\x11.protocol.Account\x1a\x18.protocol.AssetIssueList\"\x00\x12A\n" +
	"\rGetAccountNet\x12\x11.protocol.Account\x1a\x1b.protocol.AccountNetMessage\"\x00\x12K\n" +
	"\x12GetAccountResource\x12\x11.protocol.Account\x1a .protocol.AccountResourceMessage\"\x00\x12M\n" +
	...
	"\x11GetAssetIssueById\x12\x16.protocol.BytesMessage\x1a\x1c.protocol.AssetIssueContract\"\x00\x128\n" +
	"\vGetNowBlock\x12\x16.protocol.EmptyMessage\x1a\x0f.protocol.Block\"\x00\x12B\n" +
	"\fGetNowBlock2\x12\x16.protocol.EmptyMessage\x1a\x18.protocol.BlockExtention\"\x00\x12;\n" +
	"\rGetBlockByNum\x12\x17.protocol.NumberMessage\x1a\x0f.protocol.Block\"\x00\x12E\n" +
	"\x0eGetBlockByNum2\x12\x17.protocol.NumberMessage\x1a\x18.protocol.BlockExtention\"\x00\x12S\n" +
	"\x1dGetTransactionCountByBlockNum\x12\x17.protocol.NumberMessage\x1a\x17.protocol.NumberMessage\"\x00\x129\n" +
	"\fGetBlockById\x12\x16.protocol.BytesMessage\x1a\x0f.protocol.Block\"\x00\x12B\n" +
	"\x13GetBlockByLimitNext\x12\x14.protocol.BlockLimit\x1a\x13.protocol.BlockList\"\x00\x12L\n" +
	"\x14GetBlockByLimitNext2\x12\x14.protocol.BlockLimit\x1a\x1c.protocol.BlockListExtention\"\x00\x12E\n" +
	"\x13GetBlockByLatestNum\x12\x17.protocol.NumberMessage\x1a\x13.protocol.BlockList\"\x00\x12O\n" +
	"\x14GetBlockByLatestNum2\x12\x17.protocol.NumberMessage\x1a\x1c.protocol.BlockListExtention\"\x00\x12E\n" +
	"\x12GetTransactionById\x12\x16.protocol.BytesMessage\x1a\x15.protocol.Transaction\"\x00\x12Q\n" +
	...
	"\x10ClearContractABI\x12\x1a.protocol.ClearABIContract\x1a\x1e.protocol.TransactionExtention\"\x00\x12@\n" +
	"\rListWitnesses\x12\x16.protocol.EmptyMessage\x1a\x15.protocol.WitnessList\"\x00\x12Q\n" +
	...
	"\x1cGetCanWithdrawUnfreezeAmount\x121.protocol.CanWithdrawUnfreezeAmountRequestMessage\x1a2.protocol.CanWithdrawUnfreezeAmountResponseMessage\"\x00\x12A\n" +
	...
	"\x0fGetProposalById\x12\x16.protocol.BytesMessage\x1a\x12.protocol.Proposal\"\x00\x12A\n" +
	...
	"\x0fGetExchangeById\x12\x16.protocol.BytesMessage\x1a\x12.protocol.Exchange\"\x00\x12I\n" +
	"\x12GetChainParameters\x12\x16.protocol.EmptyMessage\x1a\x19.protocol.ChainParameters\"\x00\x12G\n" +
	"\x11GetAssetIssueList\x12\x16.protocol.EmptyMessage\x1a\x18.protocol.AssetIssueList\"\x00\x12T\n" +
	"\x1aGetPaginatedAssetIssueList\x12\x1a.protocol.PaginatedMessage\x1a\x18.protocol.AssetIssueList\"\x00\x12E\n" +
	"\x10TotalTransaction\x12\x16.protocol.EmptyMessage\x1a\x17.protocol.NumberMessage\"\x00\x12K\n" +
	"\x16GetNextMaintenanceTime\x12\x16.protocol.EmptyMessage\x1a\x17.protocol.NumberMessage\"\x00\x12M\n" +
	"\x16GetTransactionInfoById\x12\x16.protocol.BytesMessage\x1a\x19.protocol.TransactionInfo\"\x00\x12f\n" +
	"\x17AccountPermissionUpdate\x12).protocol.AccountPermissionUpdateContract\x1a\x1e.protocol.TransactionExtention\"\x00\x12T\n" +
	...
	"\n" +
	"GetMemoFee\x12\x16.protocol.EmptyMessage\x1a\x1f.protocol.PricesResponseMessage\"\x002\x9c\x1e\n" +
	"\x0eWalletSolidity\x124\n" +
	"\n" +
	"GetAccount\x12\x11.protocol.Account\x1a\x11.protocol.Account\"\x00\x128\n" +
	"\x0eGetAccountById\x12\x11.protocol.Account\x1a\x11.protocol.Account\"\x00\x12@\n" +
	"\rListWitnesses\x12\x16.protocol.EmptyMessage\x1a\x15.protocol.WitnessList\"\x00\x12Q\n" +
	"\x1aGetPaginatedNowWitnessList\x12\x1a.protocol.PaginatedMessage\x1a\x15.protocol.WitnessList\"\x00\x12G\n" +
	"\x11GetAssetIssueList\x12\x16.protocol.EmptyMessage\x1a\x18.protocol.AssetIssueList\"\x00\x12T\n" +
	"\x1aGetPaginatedAssetIssueList\x12\x1a.protocol.PaginatedMessage\x1a\x18.protocol.AssetIssueList\"\x00\x12M\n" +
	"\x13GetAssetIssueByName\x12\x16.protocol.BytesMessage\x1a\x1c.protocol.AssetIssueContract\"\x00\x12M\n" +
	"\x17GetAssetIssueListByName\x12\x16.protocol.BytesMessage\x1a\x18.protocol.AssetIssueList\"\x00\x12K\n" +
	"\x11GetAssetIssueById\x12\x16.protocol.BytesMessage\x1a\x1c.protocol.AssetIssueContract\"\x00\x128\n" +
	"\vGetNowBlock\x12\x16.protocol.EmptyMessage\x1a\x0f.protocol.Block\"\x00\x12B\n" +
	...
	"\rListExchanges\x12\x16.protocol.EmptyMessage\x1a\x16.protocol.ExchangeList\"\x00\x12E\n" +
	"\x12GetTransactionById\x12\x16.protocol.BytesMessage\x1a\x15.protocol.Transaction\"\x00\x12M\n" +
	"\x16GetTransactionInfoById\x12\x16.protocol.BytesMessage\x1a\x19.protocol.TransactionInfo\"\x00\x12_\n" +
	"\x18GetMerkleTreeVoucherInfo\x12\x19.protocol.OutputPointInfo\x1a&.protocol.IncrementalMerkleVoucherInfo\"\x00\x12I\n" +
	"\rScanNoteByIvk\x12\x1e.protocol.IvkDecryptParameters\x1a\x16.protocol.DecryptNotes\"\x00\x12]\n" +
	"\x14ScanAndMarkNoteByIvk\x12%.protocol.IvkDecryptAndMarkParameters\x1a\x1c.protocol.DecryptNotesMarked\"\x00\x12I\n" +
	...
	"\bGetBlock\x12\x12.protocol.BlockReq\x1a\x18.protocol.BlockExtention\"\x00\x12O\n" +
	"\x12GetBandwidthPrices\x12\x16.protocol.EmptyMessage\x1a\x1f.protocol.PricesResponseMessage\"\x00\x12L\n" +
	"\x0fGetEnergyPrices\x12\x16.protocol.EmptyMessage\x1a\x1f.protocol.PricesResponseMessage\"\x002\xf1\x02\n" +
	"\x0fWalletExtension\x12R\n" +
	"\x17GetTransactionsFromThis\x12\x1a.protocol.AccountPaginated\x1a\x19.protocol.TransactionList\"\x00\x12\\\n" +
	"\x18GetTransactionsFromThis2\x12\x1a.protocol.AccountPaginated\x1a\".protocol.TransactionListExtention\"\x00\x12P\n" +
	"\x15GetTransactionsToThis\x12\x1a.protocol.AccountPaginated\x1a\x19.protocol.TransactionList\"\x00\x12Z\n" +
	...
	"\rGetBlockByNum\x12\x17.protocol.NumberMessage\x1a\x0f.protocol.Block\"\x002J\n" +
	"\aMonitor\x12?\n" +
	"\fGetStatsInfo\x12\x16.protocol.EmptyMessage\x1a\x15.protocol.MetricsInfo\"\x002\t\n" +
	"\aNetworkBA\n" +
